...
def movies_db_refactor():
    # movies manipulation
    df = pd.read_csv('watchlist/title.basics.tsv', sep='\t', index_col="tconst")
...
def people_db_refactor():
    # people manipulation
    df = pd.read_csv('watchlist/name.basics.tsv', sep='\t', index_col="nconst")
...
def crew_db_refactor():
    # crew manipulation
    df = pd.read_csv('watchlist/title.crew.tsv', sep='\t', index_col="tconst")
...
def ratings_db_refactor():
    ...
    df = pd.read_csv('watchlist/title.ratings.tsv', sep='\t', index_col="tconst")
...
def roles_db_refactor():
    # roles manipulation
    df = pd.read_csv('watchlist/title.principals.tsv', sep='\t', index_col="tconst")
